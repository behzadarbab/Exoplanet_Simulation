...
x_list = get_list(3.0, 0.02, 5.0)
vz_list = get_list(1, 0.04, 1, rel=operator.le)
print("v:",vz_list)
inc_list = get_list(r=0, s=math.pi/(inc_count), lim=math.pi/2, rel=operator.le)
print(inc_list)
m_list = get_list(r=1.0, s=0.04, lim=1.0)
print("m:", m_list)
            ...
            for v in vz_list:
                ...
                for x in x_list:
                    ...
                    for inc in inc_list:
                        ...
                        inccounter = 0                                                  # counter for each inclination
                        ...
                        for o in omega_list:
                            ...
                            for f in f_list:
                                ...
                                if (abs(a_e.a)*(1+a_e.e))<(1+hw) and (abs(a_e.a)*(1-a_e.e))>(1-hw):
                                    inccounter += 1
                        g.write('{incpercentage:.0f}\t'.format(incpercentage=(inccounter/(omega_count*f_count))*100))
