...
omega_count= 40            #number of omegas to try from pi/(omega_count/2) to pi (we dont use pi to 2pi because it is symmetric
inc_count= 10              #number of inclinations to try from -pi/2 to pi/2 (we have 30 steps)
f_count= 40                #number of true anomalies from the step size to 2*pi
